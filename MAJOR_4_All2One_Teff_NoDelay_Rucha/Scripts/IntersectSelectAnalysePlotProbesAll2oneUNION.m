...
function [Filtered_CutIntersection_ProbeN,GeneNamesCell12, ProbeIDsCell1, PublicIDsCell1,...
         ...
         (ranks2_Treg1UNION, ranks2_Treg2UNION,ThresholdAverageIntensityCell1,...
    ...
    indexCell1 = cell2mat(ranks2_Treg1UNION(:,1));
    indexCell2 = cell2mat(ranks2_Treg2UNION(:,1));
    ...
    ranks2_Treg1UNION = [ranks2_Treg1UNION(:,1:4) ExtractProbeIDCell1];
    ranks2_Treg2UNION = [ranks2_Treg2UNION(:,1:4) ExtractProbeIDCell2];
...
%     ColumnNumberForIntersect = 6; % 6 means use public IDs to intersect
    ...
    [IntersectionTreg1Treg2_Probe2, ProbeNumberIntersection]  = intersectRanksUNION(ranks2_Treg1UNION,ranks2_Treg2UNION,...
...
%     DashDashDashOnly = IntersectionTreg1Treg2_Probe2(findLocationOfCompare,:);
    ...
    ProbeNumberIntersectionToBeKept = ProbeNumberIntersection(findLocationOfCompare,:);
    ...
    CutProbeNumberIntersectionToBeKept = ProbeNumberIntersectionToBeKept(temp_Probe2,:);
    ...
    ProbeNumberCutOrdered = ...
        CutProbeNumberIntersectionToBeKept(intersectFilteredGenes,:);
