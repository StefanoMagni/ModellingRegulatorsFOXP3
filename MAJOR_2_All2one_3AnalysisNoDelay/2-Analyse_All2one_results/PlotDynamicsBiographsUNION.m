...
function PlotDynamicsBiographsUNION(FileNameGeneOfInterestDynamics, Filtered_CutIntersection_ProbeN,...
    ...
    for line = 1:size(Filtered_CutIntersection_ProbeN,1)
        ...
        if ProbeNumberGeneOfInterestCell1 == ProbeNumberGeneOfInterestCell2
            ...
            y1NORM = y1 / max(y1);
            y2NORM = y2 / max(y2);
            SelectedGeneDataNORM1 = SelectedGeneData(1,:) / max(SelectedGeneData(1,:));
            SelectedGeneDataNORM2 = SelectedGeneData(2,:) / max(SelectedGeneData(2,:));
            plot(time_points,y1NORM,'Linewidth',1.5); 
            ...
            plot(time_points,SelectedGeneDataNORM1,'Linewidth',1.5); xlim([0 360])
            hold on;
    ...
    %             RGBcolor = Yellow;
            ...
            VariableNameToLoadCell1 = [GeneOfInterest '_Probe' ...
                num2str(ProbeNumberGeneOfInterestCell1) '_Treg12']; 
            ...
            VariableNameToLoadCell2 = [GeneOfInterest '_Probe' ...
                num2str(ProbeNumberGeneOfInterestCell2) '_Treg12']; 
            ...
            subplot(2,1,2)%(3,1, 3)
            plot(time_points,y2NORM,'Linewidth',0.7);
            hold on;
            plot(time_points,SelectedGeneDataNORM2,'Linewidth',0.7);
            ...
            title([num2str(GeneOfInterest) ' in Tregs']);
