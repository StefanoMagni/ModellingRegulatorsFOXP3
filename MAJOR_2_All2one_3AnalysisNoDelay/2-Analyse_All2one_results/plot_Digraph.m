 ...
 function plot_Digraph(Filtered_CutIntersection_ProbeN,GeneOfInterest,ProbeNumber)
...
%     Digraph = plot(D,'ArrowSize',12);                      % for normal digraph
    ...
    title([TargetGene '- Treg' num2str(cellNumber)])
...
%     labelColors = parula(length(names));
    ...
    temp=[ num2str(GeneOfInterest) '_Probe' num2str(ProbeNumber) '_',...
           'Treg' num2str(cellNumber) '_DIGRAPH','.eps']; saveas(gcf,temp,'epsc');
